...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (whatsappBtn) {
        whatsappBtn.addEventListener('click', function(e) {
            e.preventDefault();
            const message = encodeURIComponent('Olá! Gostaria de saber mais sobre as máquinas serigráficas Silk Machine.');
    ...
    console.log('Silk Machine website loaded successfully! 🚀');
});
